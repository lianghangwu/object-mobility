...
class finalClient : public jsonrpc::Client
{
    public:
        ...
        Json::Value sendMessage(const std::string& action, const std::string& class_id, const Json::Value& json_object, const std::string& object_id) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["action"] = action;
            p["class_id"] = class_id;
